...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val bmitext = view.findViewById<TextView>(R.id.bmiDashboard)
        val weightcardview = view.findViewById<TextView>(R.id.weightCard)
        val heightcardview = view.findViewById<TextView>(R.id.heightCard)
        val agecardview = view.findViewById<TextView>(R.id.AgeCard)
        val gendercardview = view.findViewById<TextView>(R.id.genderCard)
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            launch(Dispatchers.Main) {
                if (enties!!.isNotEmpty()) {
                    //  bmi1 = enties!![0].bmi
                    bmitext.text = enties[0].bmi
                    weightcardview.text = enties[0].weight
                    heightcardview.text = enties[0].height
                    agecardview.text = enties[0].age
                    gendercardview.text = enties[0].gender
                }
//                else {
//                    callpopUp()
//                }
